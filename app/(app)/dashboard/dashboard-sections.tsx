                        ...
                        <div className="flex items-center gap-1.5">
                          {transitions.map((t) => (
                            <button
                              ...
                              className={
                                t.primary
                                  ? "h-7 rounded-sm bg-[#232021] px-2.5 text-xs font-medium text-white hover:opacity-80 disabled:opacity-40 dark:bg-white dark:text-[#232021]"
                                  : "h-7 rounded-sm border border-[#E4E4E7] px-2.5 text-xs font-medium text-[#71717A] hover:border-[#FECACA] hover:text-[#B91C1C] disabled:opacity-40 dark:border-[#27272A]"
                              }
                            >
                              {isLoading ? "..." : t.label}
                            </button>
