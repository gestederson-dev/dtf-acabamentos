...
export function Sidebar() {
  ...
  return (
    <aside className="hidden md:flex flex-col w-60 min-h-screen border-r border-zinc-200 bg-white">
      {/* Logo */}
      ...
      <div className="px-3 py-3 border-t border-zinc-200">
        <div className="px-3 py-2 mb-1">
          ...
          <p className="text-xs text-zinc-500">{isSocio ? "Sócio" : "Vendedor"}</p>
        </div>
        <button
          onClick={() => signOut({ callbackUrl: "/login" })}
          className="flex items-center gap-3 w-full px-3 py-2 rounded-md text-sm text-zinc-500 hover:text-zinc-900 hover:bg-zinc-50 transition-colors"
        >
